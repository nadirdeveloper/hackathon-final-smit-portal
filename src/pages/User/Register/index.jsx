...
function Login() {
    ...
    const loginAuth = async ({ email, password, rollNo, cnic }) => {
        const response = await authService.register(email, password, rollNo, cnic)
        if (!response.success) {
            ...
            <Content style={{ padding: '0 50px', }}>
                <div className="site-layout-content">
                    ...
                    >
                        ...
                        >
                            <Input prefix={<UserOutlined className="site-form-item-icon" />} placeholder="CNIC" />
                        </Form.Item>
                        <Title level={5}>Roll No</Title>
                        <Form.Item
                            name="rollNo"
                            className="login-inputfield"
                            rules={[
                        ...
                        >
                            <Input prefix={<UserOutlined className="site-form-item-icon" />} placeholder="Roll No" />
                        </Form.Item>
